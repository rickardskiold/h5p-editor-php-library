H5PEditor.language.core = {
  ...
  reuseSuccess: ':title har importerats från H5P Hub.',
  noContentHeader: 'Inget passande innehåll?',
  noContentSuggestion: 'Skapa innehåll själv!',
  tutorials: 'Tutorials',
  contentSectionAll: 'Allt delat innehåll',
  popularContent: 'Populärt innehåll',
  allPopular: 'Allt populärt',
  newOnTheHub: 'Nytt på H5P Hub',
  allNew: 'Allt nytt',
  filterBy: 'Filtrera utifrån',
  filter: 'Filter',
  filters: {
    level: {
      dropdownLabel: 'Nivå',
      dialogHeader: 'Välj nivå på utbildning',
      dialogButtonLabel: 'Filtrera utifrån nivå på utbildning',
    },
    language: {
      dropdownLabel: 'Språk',
      dialogHeader: 'Välj språk',
      dialogButtonLabel: 'Filtrera språk',
      searchPlaceholder: 'Skriv för att söka via språk',
    },
    reviewed: {
      dropdownLabel: 'Granskat',
      dialogHeader: 'Granskat innehåll',
      dialogButtonLabel: 'Filtrera',
      optionLabel: 'Visa enbart granskat innehåll',
    },
    contentTypes: {
      dropdownLabel: 'Innehållstyper',
      dialogHeader: 'Välj innehållstyper',
      dialogButtonLabel: 'Filtrera innehållstyper',
      searchPlaceholder: 'Skriv för att söka efter innehållstyper',
    },
    disciplines: {
      dropdownLabel: 'Ämnesområde',
      dialogHeader: 'Välj ditt ämnesområde',
      dialogButtonLabel: 'Filtrera ämnesområden',
      searchPlaceholder: 'Skriv för att söka efter ämnesområden',
    },
    licenses: {
      dropdownLabel: 'Licens',
      dialogHeader: 'Välj användarvillkor',
      dialogButtonLabel: 'Filtrera licenser',
      options: { modified: 'Kan modifieras', commercial: 'Tillåter kommersiell användning' },
    },
  },
  clearFilters: 'Rensa alla filter',
  contentSearchFieldPlaceholder: 'Sök efter innehåll',
  loadingContentTitle: 'Innehåll laddas för dig...',
  loadingContentSubtitle: 'Vänta',
  by: 'Av',
  dropdownButton: 'Öppna meny',
  paginationNavigation: 'Sidonavigering',
  page: 'Sida',
  currentPage: 'Nuvarande sida',
  nextPage: 'Gå till nästa sida',
  previousPage: 'Gå till föregående sida',
  contentPreviewButtonLabel: 'Förhandsgranska',
  contentDownloadButtonLabel: 'Hämta innehåll',
  reuseContentTabLabel: 'Hämta delat innehåll',
  contentPublisherPanelHeader: 'Info om utgivare',
  noContentFoundDesc: 'Det finns inget innehåll som matchar din sökning.',
  h5pType: 'H5P-typ',
  level: 'Nivå',
  size: 'Storlek',
  failedFetchingData: 'Misslyckades med att hämta data',
  filterErrorMessage: 'Något blev fel. Uppdatera sidan.',
  in: 'i',
  navigateToParent: 'Navigera till överliggande',
  a11yTitleShowLabel: 'Visa etikett för AT',
  a11yTitleHideLabel: 'Dölj etikett för AT',
};
